...
/**
 * Test case for class Tx_Flatmgrpay_Controller_BookingController.
 *
 * @version $Id$
 ...
 */
class Tx_Flatmgrpay_Controller_BookingControllerTest extends Tx_Extbase_Tests_Unit_BaseTestCase {
	/**
